...
const MovieDetail = () => {
    ...
    useEffect(() => {
        const fetchMovie = async () => {
            try {
                ...
                setIsLoading(false); // This ensures loading state is updated even if there’s an error
            }
        };
        fetchMovie();
    }, [id]);
    ...
    if (isLoading) {
        return <div>Loading...</div>; // Simple loading message or spinner could go here
    }
        ...
        <div className="movie-detail-container">
            <div className="movie-detail-poster">
                <img
                    ...
                    alt={`Poster of ${movie.Title}`} // Improved alt text
                />
            </div>
